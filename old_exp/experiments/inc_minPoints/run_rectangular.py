...
minPointss = list(range(params["num_obj_min"], params["num_obj_max"] + 1, 2))
...
for minPoints in minPointss:
    ...
    print()
    np.savez('plot_data/inc_minPoints/' + name + '_rect.npz', minPointss=minPointss, no_clusters=no_clusters, times=times, params=params)
