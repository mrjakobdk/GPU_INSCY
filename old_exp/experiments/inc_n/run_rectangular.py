...
print("Running INSCY. ")
print()
ns = [500, 1000, 1500, 2500, 5000, 10000]#list(range(params["n_min"], params["n_max"] + 1, 500))
...
for n in ns:
    ...
    np.savez('plot_data/inc_n/' + name + '_rect.npz', ns=ns, no_clusters=no_clusters, times=times, params=params)
