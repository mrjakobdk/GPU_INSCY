...
neighborhood_sizes = data["neighborhood_sizes"]
times = data["times"]
plt.plot(neighborhood_sizes[:len(base_times)], base_times/times[:min(len(times),len(base_times))], label="CPU-Weak")
#
...
neighborhood_sizes = data["neighborhood_sizes"]
times = data["times"]
plt.plot(neighborhood_sizes[:len(base_times)], base_times/times[:min(len(times),len(base_times))], label="GPU-Weak")
