...
__global__
void restrict_dim_prop_up_multi2(int *d_new_parents_full, int* d_children_full, int *d_parents, int *d_counts, int *d_cells, int *d_dim_start,
                                 int *d_is_included_full, int *d_new_counts_full, int *d_dim_i_full,
                                 int number_of_dims, int number_of_nodes, int number_of_cells, int number_of_points);
...
__global__
void restrict_merge_is_points_included_multi2(int * d_new_parents, int *d_points_placement, int *d_cells, int *d_is_included,
