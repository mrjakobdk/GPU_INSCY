...
vector<vector<vector<int>>> run_cpu(at::Tensor X, float neighborhood_size, float F, int num_obj, int min_size, float r, int number_of_cells) {
...
vector<vector<vector<int>>>
run_gpu_memory(at::Tensor X, float neighborhood_size, float F, int num_obj, int min_size, float r,
int number_of_cells, bool rectangular, int entropy_order) {
//    printf("test0\n");
//    nvtxRangePushA("run_gpu_4");
...
nvtxRangePushA("InscyArrayGpuMemory");
InscyArrayGpuMemory(d_neighborhoods, d_neighborhood_end, tmps, scy_tree_gpu, d_X, n, subspace_size,
        neighborhood_size, F, num_obj, min_size,
        result, 0, subspace_size, r, calls, rectangular);
printf("InscyArrayGpuMemory(%d): 100%%      \n", calls);
cudaDeviceSynchronize();
nvtxRangePop();
...
nvtxRangePushA("InscyArrayGpuStar");
InscyArrayGpuStar(d_neighborhoods, d_neighborhood_end, tmps, scy_tree_gpu, d_X, n, subspace_size,
        neighborhood_size, F, num_obj, min_size,
        result, 0, subspace_size, r, calls, rectangular);
printf("InscyArrayGpuStar(%d): 100%%      \n", calls);
cudaDeviceSynchronize();
nvtxRangePop();
